...
#define UART8_FIFO_SIZE  0ul /*!< UART8 supports separated receive/transmit 0 bytes entry FIFO \hideinitializer */
#define UART9_FIFO_SIZE  0ul /*!< UART9 supports separated receive/transmit 0 bytes entry FIFO \hideinitializer */
/*---------------------------------------------------------------------------------------------------------*/
