/**************************************************************************//**
 * @file     nu_mpu_config_M3351_template.h
 * @version  V1.00
...
#ifndef __NU_MPU_CONFIG_M3351_TEMPLATE_H__
#define __NU_MPU_CONFIG_M3351_TEMPLATE_H__

/*
 * Copy from Library\StdDriver\inc\nu_mpu_config_M3351_template.h
...
//     <o>Base Address <0-0xFFFFFFE0>
*/
#define MPU_INIT_BASE1      0x00000000       /* Base address of MPU region 1 */
/*
//     <o>Region Size <0x20-0xFFFFFFFF:0x20>
*/
#define MPU_INIT_SIZE1      0x00100000       /* Size of MPU region 1 */
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define MPU_INIT_BASE7      0x00000000       /* Base address of MPU region 7 */
/*
//     <o>Region Size <0x20-0xFFFFFFFF:0x20>
*/
#define MPU_INIT_SIZE7      0x00010000       /* Size of MPU region 7 */
#define MPU_INIT_LIMIT7     (MPU_INIT_BASE7 + MPU_INIT_SIZE7 - 1)
/*
//    <o>  Memory attribute
//      <0=> Device-nGnRnE
//      <1=> Device-nGnRE
...
//   </e>
*/
#if (MPU_INIT_REGION7 == 1) /* Check region config */
    #if (MPU_INIT_LIMIT7 <= MPU_INIT_BASE7)
        #error "MPU region 7 has invalid base address or size config !"
    #endif

    #if ((1 << MPU_MEM_ATTR7) & (MPU_INIT_MEM_ATTRS) == 0)
...
#define MPU_INIT_REGIONS            ((MPU_INIT_REGION0 << 0) | (MPU_INIT_REGION1 << 1) | (MPU_INIT_REGION2 << 2) | (MPU_INIT_REGION3 << 3) | \
                                     (MPU_INIT_REGION4 << 4) | (MPU_INIT_REGION5 << 5) | (MPU_INIT_REGION6 << 6) | (MPU_INIT_REGION6 << 7))
...
#endif  // __NU_MPU_CONFIG_M3351_TEMPLATE_H__
