...
#define EADC_PWM1TG1_TRIGGER                (0x1BL<<EADC_SCTL_TRGSEL_Pos)    /*!< PWM1TG1 trigger \hideinitializer */
...
#define EADC_MCTL1_EXTSAMPLE_DIVIDER_1      (0x0UL << EADC_MCTL1_EXTSTDIV_Pos)  /*!< EADC Extended Sampling Time Clock Divider is EADC_CLK/1 \hideinitializer */
#define EADC_MCTL1_EXTSAMPLE_DIVIDER_2      (0x1UL << EADC_MCTL1_EXTSTDIV_Pos)  /*!< EADC Extended Sampling Time Clock Divider is EADC_CLK/2 \hideinitializer */
#define EADC_MCTL1_EXTSAMPLE_DIVIDER_4      (0x2UL << EADC_MCTL1_EXTSTDIV_Pos)  /*!< EADC Extended Sampling Time Clock Divider is EADC_CLK/4 \hideinitializer */
#define EADC_MCTL1_EXTSAMPLE_DIVIDER_16     (0x3UL << EADC_MCTL1_EXTSTDIV_Pos)  /*!< EADC Extended Sampling Time Clock Divider is EADC_CLK/16 \hideinitializer */
...
#define EADC_ARG_ERR                        (-4)    /*!< EADC argument error \hideinitializer */
...
/**
  ...
  *                             This parameter decides which sample module interrupts will be disabled (valid values: EADC0 = 1~0x3FFFFFF, EADC1 = 1~0xFFFF).
  * @return     None
  * @details    When A/D conversion is completed, the converted data is loaded into EADC_DATn (n: EADC0 = 0~26, EADC1 = 0~15) register,
...
/**
  ...
  * @param[in]  eadc            The pointer of the specified EADC module.
  * @param[in]  u32ModuleMask   The combination of sample module interrupt status bits. Each bit corresponds to a sample module interrupt status.
  *                             This parameter decides which sample module interrupts will be disabled (valid range: EADC0 = 1~0x3FFFFFF, EADC1 = 1~0xFFFF).
  * @return     None
...
/**
  ...
  * \hideinitializer
  */
#define EADC_ENABLE_INT_POSITION(eadc, u32ModuleNum)     (((u32ModuleNum) < 19UL) ? ((eadc)->SCTL[(u32ModuleNum)] |= EADC_SCTL_INTPOS_Msk) : ((eadc)->SCTL19[(u32ModuleNum)-19UL] |= EADC_SCTL_INTPOS_Msk))
/**
  ...
  * \hideinitializer
  */
#define EADC_DISABLE_INT_POSITION(eadc, u32ModuleNum)   (((u32ModuleNum)< 19UL) ? ((eadc)->SCTL[(u32ModuleNum)] &= ~EADC_SCTL_INTPOS_Msk) : ((eadc)->SCTL19[(u32ModuleNum)-19UL] &= ~EADC_SCTL_INTPOS_Msk))
/**
...
/**
  ...
  * @param[in]  u32ModuleMask   The combination of sample module interrupt status bits. Each bit corresponds to a sample module interrupt status.
  *                             This parameter decides which sample module interrupts will be enabled (valid range: EADC0 = 1~0x3FFFFFF, EADC1 = 1~0xFFFF).
  * @return     None
...
/**
  ...
  *                             This parameter decides which sample module will be conversion (valid range: EADC0 = 1~0x3FFFFFF, EADC1 = 1~0xFFFF).
  *                             Bit 0 is sample module 0, bit 1 is sample module 1, … Each bit n corresponds to sample module n.
  * @return     None
...
/**
  ...
  * @param[in]  eadc            The pointer of the specified EADC module.
  * @param[in]  u32ModuleMask   The combination of sample module. Each bit corresponds to a sample module.
  *                             This parameter decides which sample module will stop the conversion, valid range are between 1~0x3FFFFFF.
  *                             Bit 0 is sample module 0, bit 1 is sample module 1, … Each bit n corresponds to sample module n.
  * @return     None
...
/**
  ...
  * @details    This STPFn (n: EADC0 = 0~26, EADC1 = 0~15) bit remains 1 during pending state, when the respective EADC conversion is end,
  *             the STPFn (n: EADC0 = 0~26, EADC1 = 0~15) bit is automatically cleared to 0.
  * \hideinitializer
  */
...
/**
  ...
  * \hideinitializer
  */
__STATIC_INLINE uint32_t EADC_GET_CONV_DATA(EADC_T *eadc, uint32_t u32ModuleNum)
{
    uint32_t adc_result_mask;

    if (eadc == EADC0)
    {
        adc_result_mask = EADC_DAT_RESULT_Msk;
    }
    else if (eadc == EADC1)
    {
        adc_result_mask = EADC1_DAT_RESULT_Msk;
    }
    else
    {
        adc_result_mask = 0xfffUL;
    }

    return (((u32ModuleNum) < 19UL) ? ((eadc)->DAT[(u32ModuleNum)] & adc_result_mask) : ((eadc)->DAT19[(u32ModuleNum) - 19UL] & adc_result_mask));
}
 ...
 *
 *    @param[in]    eadc    The pointer of the specified EADC module
 *    @param[in]    u32ModuleMask   The combination of data valid status bits. Each bit corresponds to a data valid status (valid range: EADC0 = 1~0x3FFFFFF, EADC1 = 1~0xFFFF).
...
__STATIC_INLINE uint32_t EADC_GET_DATA_VALID_FLAG(const EADC_T *eadc, uint32_t u32ModuleMask)
{
    ...
    u32VALID |= ((eadc->STATUS1 & EADC_STATUS1_VALID_Msk) << 16UL);
 ...
 *
 *    @param[in]    eadc    The pointer of the specified EADC module
 *    @param[in]    u32ModuleMask   The combination of data overrun status bits. Each bit corresponds to a data valid status (valid range: EADC0 = 1~0x3FFFFFF, EADC1 = 1~0xFFFF).
 *    @return       Return the data valid flag of the user-specified sample module.
 *
...
/**
  ...
  * \hideinitializer
  */
__STATIC_INLINE uint32_t EADC_GET_DOUBLE_DATA(EADC_T *eadc, uint32_t u32ModuleNum)
{
    uint32_t adc_result_mask;

    if (eadc == EADC0)
    {
        adc_result_mask = EADC_DDAT_RESULT_Msk;
    }
    else if (eadc == EADC1)
    {
        adc_result_mask = EADC1_DDAT_RESULT_Msk;
    }
    else
    {
        adc_result_mask = 0xfffUL;
    ...
    return ((eadc)->DDAT[(u32ModuleNum)] & adc_result_mask);
}
...
/**
  ...
  * @param[in]  eadc            The pointer of the specified EADC module.
  * @param[in]  u32ModuleMask   The combination of sample module overrun status bits. Each bit corresponds to a sample module overrun status (valid range: EADC0 = 1~0x3FFFFFF, EADC1 = 1~0xFFFF).
...
/**
  ...
  *                             Bit 0 is SPOVF0, bit 1 is SPOVF1..., bit n is SPOVFn.
  * @return     None
...
/**
  ...
  * @details    The AVALID bit will keep 1 when any one of sample module data register valid flag VALIDn (EADC_DATn[31]) is set to 1.
  * \hideinitializer
  */
...
/**
  ...
  * @details    The STOVF bit will keep 1 when any one of sample module event overrun flag SPOVFn (n: EADC0 = 0~26, EADC1 = 0~15) is set to 1.
  * \hideinitializer
  */
...
/**
  ...
  * @param[in]  eadc            The pointer of the specified EADC module.
  * @param[in]  u32ModuleNum    Specifies the compare sample module (valid values: EADC0 = 0~26, EADC1 = 0~15).
  ...
  * @param[in]  u16CMPData      Specifies the compare value (valid range: EADC0 = 1~0xFFFF, EADC1 = 1~0x3FFFF).
  ...
  * \hideinitializer
  */
__STATIC_INLINE void EADC_ENABLE_CMP0(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
    uint32_t adc_cmpdat_msk;

    if (eadc == EADC0)
    {
        adc_cmpdat_msk = EADC_CMP_CMPDAT_Msk;

    }
    else if (eadc == EADC1)
    {
        adc_cmpdat_msk = EADC1_CMP_CMPDAT_Msk;
    }
    else
    {
        adc_cmpdat_msk = 0xfffUL;
    }

    ((eadc)->CMP[0] = (((eadc)->CMP[0] & ~(EADC_CMP_CMPSPL_Msk | EADC_CMP_CMPCOND_Msk | adc_cmpdat_msk | EADC_CMP_CMPMCNT_Msk)) | \
...
/**
  ...
  * \hideinitializer
  */
__STATIC_INLINE void EADC_ENABLE_CMP1(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
    uint32_t adc_cmpdat_msk;
    ...
    ((eadc)->CMP[1] = (((eadc)->CMP[1] & ~(EADC_CMP_CMPSPL_Msk | EADC_CMP_CMPCOND_Msk | adc_cmpdat_msk | EADC_CMP_CMPMCNT_Msk)) | \
                       (((u32ModuleNum) << EADC_CMP_CMPSPL_Pos) | \
                        (u32Condition) | \
                        ((u16CMPData) << EADC_CMP_CMPDAT_Pos) | \
                        (((u32MatchCount) - 1UL) << EADC_CMP_CMPMCNT_Pos) | \
...
/**
  ...
  * \hideinitializer
  */
__STATIC_INLINE void EADC_ENABLE_CMP2(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
    uint32_t adc_cmpdat_msk;
    ...
    ((eadc)->CMP[2] = (((eadc)->CMP[2] & ~(EADC_CMP_CMPSPL_Msk | EADC_CMP_CMPCOND_Msk | adc_cmpdat_msk | EADC_CMP_CMPMCNT_Msk)) | \
                       (((u32ModuleNum) << EADC_CMP_CMPSPL_Pos) | \
                        (u32Condition) | \
                        ((u16CMPData) << EADC_CMP_CMPDAT_Pos) | \
                        (((u32MatchCount) - 1UL) << EADC_CMP_CMPMCNT_Pos) | \
...
/**
  ...
  *                             - \ref EADC_CMP_CMPCOND_LESS_THAN           :The compare condition is "less than the compare value"
  *                             - \ref EADC_CMP_CMPCOND_GREATER_OR_EQUAL    :The compare condition is "greater than or equal to the compare value"
  * @param[in] u16CMPData       Specifies the compare value (valid range: EADC0 = 0~0xFFF, EADC1 = 0~0x3FFF).
  * @param[in] u32MatchCount    Specifies the match count setting, valid range are between 0~0xF.
  * @return     None
  ...
  * \hideinitializer
  */
__STATIC_INLINE void EADC_ENABLE_CMP3(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32Condition, uint32_t u16CMPData, uint32_t u32MatchCount)
{
    uint32_t adc_cmpdat_msk;
    ...
    ((eadc)->CMP[3] = (((eadc)->CMP[3] & ~(EADC_CMP_CMPSPL_Msk | EADC_CMP_CMPCOND_Msk | adc_cmpdat_msk | EADC_CMP_CMPMCNT_Msk)) | \
                       (((u32ModuleNum) << EADC_CMP_CMPSPL_Pos) | \
                        (u32Condition) | \
                        ((u16CMPData) << EADC_CMP_CMPDAT_Pos) | \
                        (((u32MatchCount) - 1UL) << EADC_CMP_CMPMCNT_Pos) | \
...
/**
  ...
  * @param[in]  u32ModuleNum    Decides the sample module number (valid values: EADC0 = 0~26, EADC1 = 0~15).
  * @return     None
  * @details    The conversion result will be left aligned and stored in EADC_DATn (EADC0:EADC_DATn[15:4](n=0~23),EADC1:EADC_DATn[17:4](n=0~15)).
  * \hideinitializer
  */
...
/**
  ...
  * @param[in]  u32ModuleNum    Decides the sample module number (valid values: EADC0 = 0~26, EADC1 = 0~15).
  * @return     None
  * @details    The conversion result will be right aligned and stored in EADC_DATn (EADC0:EADC_DATn[11:0](n=0~23),EADC1:EADC_DATn[13:0](n=0~15)).
  * \hideinitializer
  */
...
/**
  ...
  * @return     None
  * @details    When accumulating more than 16 samples, the result will be too large to match the RESULT register size (EADC0:EADC_DATn[15:0], EADC1:EADC_DATn[17:0]).
  *             To avoid overflow, the result is right shifted automatically to fit within the available register size.
