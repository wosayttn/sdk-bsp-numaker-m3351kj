...
#define DAC_PWM0_TRIGGER           ((8UL<<DAC_CTL_TRGSEL_Pos)|DAC_CTL_TRGEN_Msk)   /*!< PWM0 trigger \hideinitializer */
#define DAC_PWM1_TRIGGER           ((9UL<<DAC_CTL_TRGSEL_Pos)|DAC_CTL_TRGEN_Msk)   /*!< PWM1 trigger \hideinitializer */
...
/**
  ...
  * @param[in] dac Base address of DAC module.
  * @param[in] u32Ch Not used in M3351 DAC.
  * @return None
