...
#define EQEI_CTL_PHASE_COUNTING_MODE_TYPE2   (0x5<<EQEI_CTL_MODE_Pos) /*!< EQEI operate in phase counting mode type 2 \hideinitializer */
...
/*---------------------------------------------------------------------------------------------------------*/
#define EQEI_CTL2_DIRECTION_FROM_EQEI_CALC   (0x0<<EQEI_CTL2_DIRSRC_Pos)  /*!<Direction signal is determined from EQEI system calculation   \hideinitializer */
#define EQEI_CTL2_DIRECTION_TIED_HIGH        (0x2<<EQEI_CTL2_DIRSRC_Pos)  /*!<Direction signal is tied 1 only for direction up count mode   \hideinitializer */
#define EQEI_CTL2_DIRECTION_TIED_LOW         (0x3<<EQEI_CTL2_DIRSRC_Pos)  /*!<Direction signal is tied 0 only for direction down count mode \hideinitializer */
...
/**
  ...
  * \hideinitializer
  */
#define EQEI_ENABLE_INPUT_INV(eqei, u32InputType)     ((eqei)->CTL |= (u32InputType))
...
/**
  ...
  *
  * @param[in]  eqei       The pointer of the specified Eqei module. It could be EQEI0, EQEI1.
...
/**
  ...
  *                         - \ref EQEI_CTL2_DIRECTION_FROM_EQEI_CALC
  *                         - \ref EQEI_CTL2_DIRECTION_TIED_HIGH
  *                         - \ref EQEI_CTL2_DIRECTION_TIED_LOW
  * @return     None
...
/**
  * @brief      Disable Uint timer interrupt
  *
  * @param[in]  eqei       The pointer of the specified EQEI module. It could be EQEI0, EQEI1.
  *
  * @return     None
  *
  * @details    This function is used to disable the uint timer interrupt.
  */
__STATIC_INLINE void EQEI_DisableUintTimerINT(EQEI_T *eqei)
{
    eqei->CTL2 &= ~EQEI_CTL2_UTIEIEN_Msk;
