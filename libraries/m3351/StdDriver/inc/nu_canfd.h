...
/* CAN FD sram size  */
#define CANFD_SRAM_SIZE              (256 * sizeof(uint32_t))
...
typedef enum
{
    ...
    eCANFD_MSG_DRB          = 0x2,              /*!< Dedicated RX Buffer */
    eCANFD_MSG_DTB          = 0x3,              /*!< Dedicated TX Buffer */
    eCANFD_MSG_TFQ          = 0x4,              /*!< TX FIFO/QUEUE */
    eCANFD_MSG_TEF          = 0x5,              /*!< TX EVENT FIFO */
    eCANFD_MSG_SID          = 0x6,              /*!< Standard ID Filter */
    eCANFD_MSG_XID          = 0x7,              /*!< Extended ID Filter */
} E_CANFD_MSG;
