...
#endif
#if defined (SCU_INIT_IONSSET2_VAL) && (SCU_INIT_IONSSET2_VAL & BIT14 )
...
#endif
#if defined (SCU_INIT_IONSSET3_VAL) && (SCU_INIT_IONSSET3_VAL & BIT13 )
...
#endif
#if defined (SCU_INIT_IONSSET3_VAL) && (SCU_INIT_IONSSET3_VAL & BIT15 )
#define PD15              PD15_NS   /*!< Specify PD.15 Pin Data Input/Output */
#else
#define PD15              PD15_S    /*!< Specify PD.15 Pin Data Input/Output */
#endif
...
#endif
#if defined (SCU_INIT_IONSSET5_VAL) && (SCU_INIT_IONSSET5_VAL & BIT14 )
#define PF14              PF14_NS   /*!< Specify PF.14 Pin Data Input/Output */
#else
#define PF14              PF14_S    /*!< Specify PF.14 Pin Data Input/Output */
#endif
...
#define PD15_S           GPIO_PIN_DATA_S(3, 15) /*!< Specify PD.15 Pin Data Input/Output */
...
#define PF14_S           GPIO_PIN_DATA_S(5, 14) /*!< Specify PF.14 Pin Data Input/Output */
 ...
 *              It's meaning the De-debounce counter clock source is internal 38.4 KHz and sampling cycle selection is 4. \n
 *              Then the target de-bounce sampling cycle time is (4)*(1/(38.4*1000)) s = 104.2 us,
 *              and system will sampling interrupt input once per 104.2 us.
 */
...
/**
 * @brief       Get EINT Pin Interrupt Flag
 *
 * @param[in]   u32EINTn    The specified EINT.
 *                          It could be 0 ~ 7 for EINT0, EINT1, EINT2, EINT3, EINT4, EINT5, EINT6 and EINT7.
 * @retval      0           No interrupt at specified EINT pin
 * @retval      1           The specified EINT pin generate an interrupt
 *
 * @details     Get the interrupt status of specified EINT pin.
 * \hideinitializer
 */
#define GPIO_GET_EINT_FLAG(u32EINTn)     (GPIO->EINT[u32EINTn].EDSTS & (GPIO_INT_EDSTS_EDIF_Msk))

/**
 * @brief       Clear EINT Pin Interrupt Flag
 *                          It could be 0 ~ 7 for EINT0, EINT1, EINT2, EINT3, EINT4, EINT5, EINT6 and EINT7.
 * @param[in]   u32EINTn    The specified EINT.
 *
 * @details     Clear the interrupt status of specified EINT pin.
 * \hideinitializer
 */
#define GPIO_CLR_EINT_FLAG(u32EINTn)     (GPIO->EINT[u32EINTn].EDSTS = GPIO_INT_EDSTS_EDIF_Msk)
