...
static rt_uint8_t nu_eadc_get_resolution(struct rt_adc_device *device)
{
    ...
    /* 12-bit for EADC0 or 14-bit for EADC1 */
    return (psNuEADC->base == EADC0) ? 12 : ((psNuEADC->base == EADC1) ? 14 : 0);
}
