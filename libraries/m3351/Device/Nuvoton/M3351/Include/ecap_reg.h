...
typedef struct
{
     ...
     * |        |          |00 = CAP0 input is from port pin ECAPx_IC0.
     * |        |          |01 = CAP0 input is from signal ACMP0_O.
     * |        |          |10 = CAP0 input is from signal CHA of EQEI controller unit n.
     * |        |          |11 = Reserved.
     * |        |          |Note: Input capture unit n matches EQEIn, where n = 0~3.
     * |        |          |Note: ECAPx,unit x, x = 0,1,2,3.
     * |[11:10] |CAPSEL1   |CAP1 Input Source Selection
     * |        |          |00 = CAP1 input is from port pin ECAPx_IC1.
     * |        |          |01 = CAP1 input is from signal ACMP1_O.
     * |        |          |10 = CAP1 input is from signal CHB of EQEI controller unit n.
     * |        |          |11 = Reserved.
     * |        |          |Note: Input capture unit n matches EQEIn, where n = 0~3.
     * |        |          |Note: ECAPx,unit x, x = 0,1,2,3.
     * |[13:12] |CAPSEL2   |CAP2 Input Source Selection
     * |        |          |00 = CAP2 input is from port pin ECAPx_IC2.
     * |        |          |01 = CAP2 input is from signal ACMP2_O.
     * |        |          |10 = CAP2 input is from signal CHX of EQEI controller unit n.
     * |        |          |11 = Reserved.
     * |        |          |Note: Input capture unit n matches EQEIn, where n = 0~3.
     * |        |          |Note: ECAPx,unit x, x = 0,1,2,3.
     * |[16]    |CAPIEN0   |Input Capture Channel 0 Interrupt Enable Bit
     ...
     * |[17]    |CAPIEN1   |Input Capture Channel 1 Interrupt Enable Bit
     ...
     * |[18]    |CAPIEN2   |Input Capture Channel 2 Interrupt Enable Bit
     ...
     * |[20]    |OVIEN     |CAPOVF Trigger Input Capture Interrupt Enable Bit
     ...
     * |[21]    |CMPIEN    |CAPCMPF Trigger Input Capture Interrupt Enable Bit
     ...
     * |[28]    |CMPEN     |Compare Function Enable Bit
     ...
     * |        |          |Note: This bit is only cleared by writing 1 to it.
     * |[8]     |CAP0      |Value of Input Channel 0, CAP0 (Read Only)
     * |        |          |Reflecting the value of input channel 0, CAP0
     * |        |          |Note: The bit is read only and write is ignored.
     * |[9]     |CAP1      |Value of Input Channel 1, CAP1 (Read Only)
     * |        |          |Reflecting the value of input channel 1, CAP1
     * |        |          |Note: The bit is read only and write is ignored.
     * |[10]    |CAP2      |Value of Input Channel 2, CAP2 (Read Only)
     * |        |          |Reflecting the value of input channel 2, CAP2.
     * |        |          |Note: The bit is read only and write is ignored.
     */
    __IO uint32_t CNT;                   /*!< [0x0000] Input Capture Counter (24-bit Up Counter)                        */
...
#define ECAP_HLD_HOLD_Pos               (0)                                         /*!< ECAP_T::HLD: HOLD Position                 */
#define ECAP_HLD_HOLD_Msk               (0xffffffUL << ECAP_HLD_HOLD_Pos)           /*!< ECAP_T::HLD: HOLD Mask                     */
