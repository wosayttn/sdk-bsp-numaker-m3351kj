...
typedef struct
{
     ...
     * |        |          |When TSS (CANFD_TSCC[1:0]) = 0x1, the Timestamp Counter is incremented in multiples of CAN bit times [ 1...16 ] depending on the configuration of TCP (CANFD_TSCC[19:16])
     ...
     * |        |          |Note: For use of timeout function with CAN FD, refer to Timeout Counter section1.1.5.3.
     ...
     * |[4:3]   |ACT       |Activity
     * |        |          |Monitors the communication state of the CAN module.
     ...
     * |        |          |Start address of standard Message ID filter list (32-bit word address, refer to Figure 1.1-11Figure 1.1-11).
     ...
     * |        |          |Start address of extended Message ID filter list (32-bit word address, refer to Figure 1.1-11Figure 1.1-11).
     ...
     * |        |          |Start address of Rx FIFO 1 in Message RAM (32-bit word address, refer to Figure 1.1-11Figure 1.1-11).
     ...
     * |        |          |Start address of Tx Buffers section in Message RAM (32-bit word address, refer to Figure 1.1-11Figure 1.1-11).
     ...
     * |        |          |Start address of Tx Event FIFO in Message RAM (32-bit word address, refer to Figure 1.1-11Figure 1.1-11).
