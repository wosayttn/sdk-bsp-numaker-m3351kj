...
typedef struct
{
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |ELLSIEN   |LLSIELLSI Enable Bit
     * |        |          |0 = LLSI ELLSI Disabled.
     * |        |          |1 = LLSI ELLSI Enabled.
     * |[1]     |RSTCEN    |Reset Command Function Enable Bit
     * |        |          |0 = Reset command function Disabled.
     * |        |          |1 = Reset command function Enabled.
     * |        |          |Note: If this bit is enabled, when FIFO and shift register are both empty, LLSI ELLSI will send reset command out.
     * |[2]     |UNDFLINTEN|Underflow Interrupt Enable Bit
     * |        |          |0 = Underflow interrupt Disabled.
     * |        |          |1 = Underflow interrupt Enabled.
     * |        |          |Note: If this bit is enabled, when the UNDFLIF interrupt flag is set to 1, the LLSI ELLSI interrupt signal is generated and inform to CPU.
     * |[3]     |FENDINTEN |Frame End Interrupt Enable Bit
     * |        |          |0 = Frame end interrupt Disabled.
     * |        |          |1 = Frame end interrupt Enabled.
     * |        |          |Note: If this bit is enabled, when the FENDIF interrupt flag is set to 1, the LLSI ELLSI interrupt signal is generated and inform to CPU.
     * |[4]     |RSTCINTEN |Reset Command Interrupt Enable Bit
     * |        |          |0 = Reset command interrupt Disabled.
     * |        |          |1 = Reset command interrupt Enabled.
     * |        |          |Note: If this bit is enabled, when the RSTCIF interrupt flag is set to 1, the LLSI ELLSI interrupt signal is generated and inform to CPU.
     * |[5]     |EMPINTEN  |FIFO Empty Interrupt Enable Bit
     * |        |          |0 = FIFO empty interrupt Disabled.
     * |        |          |1 = FIFO empty interrupt Enabled.
     * |        |          |Note: If this bit is enabled, when the EMPIF interrupt flag is set to 1, the LLSI ELLSI interrupt signal is generated and inform to CPU.
     * |[6]     |FULINTEN  |FIFO Full Interrupt Enable Bit
     * |        |          |0 = FIFO full interrupt Disabled.
     * |        |          |1 = FIFO full interrupt Enabled.
     * |        |          |Note: If this bit is enabled, when the FULIF interrupt flag is set to 1, the LLSI ELLSI interrupt signal is generated and inform to CPU.
     ...
     * |[8]     |ELLSIMODE |LLSIELLSI Mode Select
     * |        |          |0 = Software mode.
     * |        |          |1 = PDMA mode.
     ...
     * |        |          |00 = LLSI Mode.
     * |        |          |01 = Normal Command mode
     * |        |          |It includes CLR_ID, SetET_ID, CHK_ID, SPE_ID, TH20 SET Mode and Feedback mode.
     * |        |          |10 = AUTO SET Mode.
     ...
     * |        |          |Note: Normal Command Responses are SET_ID, CHK_ID, and the error flags are ELLSI_CMDSTS[135:8]
     * |[29]    |FBSTSIEN  |Feedback Status Interrupt Enable Bit
     * |        |          |0 = Feedback Status Interrupt Disabled.
     * |        |          |1 = Feedback Status Interrupt Enabled.
     * |[30]    |ASETIEN   |AutoUTO SetET Mode Interrupt Enable Bit
     * |        |          |0 = AutoUTO SetET Mode Interrupt Disabled.
     * |        |          |1 = AutoUTO SetET Mode Interrupt Enabled.
     * |[31]    |ATHIEN    |AUTO TH20 SET Mode Interrupt Enable Bit
     * |        |          |0 = AUTO TH20 SET Mode Interrupt Disabled.
     * |        |          |1 = AUTO TH20 SET Mode Interrupt Enabled.Reserved.
     ...
     * |        |          |Reset command time = LLSI ELLSI_CLK * (DIVIDER+1) * RSTPERIOD.
     * @var ELLSI_T::PERIOD
     * Offset: 0x08  ELLSI Period Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[7:0]   |PERIOD    |LLSIELLSI Period Register
     * |        |          |This field is used to define data transfer time (TH+TL).
     * |        |          |Data transfer time = LLSI ELLSI_CLK * (DIVIDER+1) * PERIOD.
     * @var ELLSI_T::DUTY
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[7:0]   |DIVIDER   |LLSIELLSI Clock Divider
     * |        |          |It indicates the LLSI ELLSI clock,
     * |[23:16] |CMDDIV    |ELLSI Command Clock Divider
     * |        |          |It indicates the ELLSI command clock,
     * @var ELLSI_T::STATUS
     ...
     * |        |          |This bit indicates that LLSI ELLSI has finished reset command transmission.
     ...
     * |        |          |Each transmission LLSI ELLSI reads 3 bytes data from the FIFO
     * |        |          |This bit is set to 1 when LLSI ELLSI reads the FIFO and the valid data in FIFO is less than 3 bytes.
     * |        |          |Software can write 1 to clear this bit.
     * |[5]     |FENDIF    |Frame End Interrupt Flag
     * |        |          |This bit indicates that LLSI ELLSI has finished data transmission (FIFO empty & shift register empty)
     * |        |          |When LLSI ELLSI transfer finish (FIFO empty & shift register empty) this bit is set to 1.
     * |        |          |User can use this flag to prepare data in advance.
     * |        |          |Software can write 1 to clear this bit.
     * |[8]     |LDT       |Last Data Transmit
     * |        |          |Software should set LDT = 1 before write last data to LLSI ELLSI_DATA
     * |        |          |This bit will auto clear by hardware after LLSI ELLSI has finished data transmission.
     * @var ELLSI_T::OCTL
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[7:0]   |FBCNT0    |Feedback Count Current 0 Period Register
     * |        |          |Time period threshold to check Feedback Count Current 0.
     * |[11:8]  |FBC0TOL   |Feedback cCount current 0 tTolerance Register
     * |        |          |It can set tolerance Feedback Count Current 0 Pulse Period.
     * |[23:16] |FBCNT1    |Feedback Count Current 1 Period Register
     * |        |          |Time period threshold to check Feedback Count Current 1.
     * |[27:24] |FBC1TOL   |Feedback cCount current 1 tTolerance Register
     * |        |          |It can set tolerance Feedback Count Current 1 Pulse Period.
     ...
     * |[11:8]  |FBID0TOL  |Feedback Strip ID 0 tTolerance Register
     ...
     * |[27:24] |FBID1TOL  |Feedback Strip ID 1 tTolerance Register
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[23:0]  |TH20CMD   |24-bit TH20 Command dData
     ...
     * |        |          |Wakeup Pulse Period.
     * |[31:16] |WKWPER    |Wakeup wWait pPeriod
...
#define ELLSI_FBPCNT1_FBPCNT_Pos         (0)                                               /*!< ELLSI_T::FBPCNT1: FBPCNT Position      */
#define ELLSI_FBPCNT1_FBPCNT_Msk         (0x3fful << ELLSI_FBPCNT1_FBPCNT_Pos)             /*!< ELLSI_T::FBPCNT1: FBPCNT Mask          */

#define ELLSI_FBPCNT1_FBPOV_Pos          (16)                                              /*!< ELLSI_T::FBPCNT1: FBPOV Position       */
#define ELLSI_FBPCNT1_FBPOV_Msk          (0x1ul << ELLSI_FBPCNT1_FBPOV_Pos)                /*!< ELLSI_T::FBPCNT1: FBPOV Mask           */

#define ELLSI_FBPCNT1_FBPCUR_Pos         (24)                                              /*!< ELLSI_T::FBPCNT1: FBPCUR Position      */
#define ELLSI_FBPCNT1_FBPCUR_Msk         (0x1ul << ELLSI_FBPCNT1_FBPCUR_Pos)               /*!< ELLSI_T::FBPCNT1: FBPCUR Mask          */

#define ELLSI_FBSID1_FBSID_Pos           (0)                                               /*!< ELLSI_T::FBSID1: FBSID Position        */
#define ELLSI_FBSID1_FBSID_Msk           (0xfffffffful << ELLSI_FBSID1_FBSID_Pos)          /*!< ELLSI_T::FBSID1: FBSID Mask            */

#define ELLSI_FBPCNT2_FBPCNT_Pos         (0)                                               /*!< ELLSI_T::FBPCNT2: FBPCNT Position      */
#define ELLSI_FBPCNT2_FBPCNT_Msk         (0x3fful << ELLSI_FBPCNT2_FBPCNT_Pos)             /*!< ELLSI_T::FBPCNT2: FBPCNT Mask          */

#define ELLSI_FBPCNT2_FBPOV_Pos          (16)                                              /*!< ELLSI_T::FBPCNT2: FBPOV Position       */
#define ELLSI_FBPCNT2_FBPOV_Msk          (0x1ul << ELLSI_FBPCNT2_FBPOV_Pos)                /*!< ELLSI_T::FBPCNT2: FBPOV Mask           */

#define ELLSI_FBPCNT2_FBPCUR_Pos         (24)                                              /*!< ELLSI_T::FBPCNT2: FBPCUR Position      */
#define ELLSI_FBPCNT2_FBPCUR_Msk         (0x1ul << ELLSI_FBPCNT2_FBPCUR_Pos)               /*!< ELLSI_T::FBPCNT2: FBPCUR Mask          */

#define ELLSI_FBSID2_FBSID_Pos           (0)                                               /*!< ELLSI_T::FBSID2: FBSID Position        */
#define ELLSI_FBSID2_FBSID_Msk           (0xfffffffful << ELLSI_FBSID2_FBSID_Pos)          /*!< ELLSI_T::FBSID2: FBSID Mask            */

#define ELLSI_FBPCNT3_FBPCNT_Pos         (0)                                               /*!< ELLSI_T::FBPCNT3: FBPCNT Position      */
#define ELLSI_FBPCNT3_FBPCNT_Msk         (0x3fful << ELLSI_FBPCNT3_FBPCNT_Pos)             /*!< ELLSI_T::FBPCNT3: FBPCNT Mask          */

#define ELLSI_FBPCNT3_FBPOV_Pos          (16)                                              /*!< ELLSI_T::FBPCNT3: FBPOV Position       */
#define ELLSI_FBPCNT3_FBPOV_Msk          (0x1ul << ELLSI_FBPCNT3_FBPOV_Pos)                /*!< ELLSI_T::FBPCNT3: FBPOV Mask           */

#define ELLSI_FBPCNT3_FBPCUR_Pos         (24)                                              /*!< ELLSI_T::FBPCNT3: FBPCUR Position      */
#define ELLSI_FBPCNT3_FBPCUR_Msk         (0x1ul << ELLSI_FBPCNT3_FBPCUR_Pos)               /*!< ELLSI_T::FBPCNT3: FBPCUR Mask          */

#define ELLSI_FBSID3_FBSID_Pos           (0)                                               /*!< ELLSI_T::FBSID3: FBSID Position        */
#define ELLSI_FBSID3_FBSID_Msk           (0xfffffffful << ELLSI_FBSID3_FBSID_Pos)          /*!< ELLSI_T::FBSID3: FBSID Mask            */

#define ELLSI_FBPCNT4_FBPCNT_Pos         (0)                                               /*!< ELLSI_T::FBPCNT4: FBPCNT Position      */
#define ELLSI_FBPCNT4_FBPCNT_Msk         (0x3fful << ELLSI_FBPCNT4_FBPCNT_Pos)             /*!< ELLSI_T::FBPCNT4: FBPCNT Mask          */

#define ELLSI_FBPCNT4_FBPOV_Pos          (16)                                              /*!< ELLSI_T::FBPCNT4: FBPOV Position       */
#define ELLSI_FBPCNT4_FBPOV_Msk          (0x1ul << ELLSI_FBPCNT4_FBPOV_Pos)                /*!< ELLSI_T::FBPCNT4: FBPOV Mask           */

#define ELLSI_FBPCNT4_FBPCUR_Pos         (24)                                              /*!< ELLSI_T::FBPCNT4: FBPCUR Position      */
#define ELLSI_FBPCNT4_FBPCUR_Msk         (0x1ul << ELLSI_FBPCNT4_FBPCUR_Pos)               /*!< ELLSI_T::FBPCNT4: FBPCUR Mask          */

#define ELLSI_FBSID4_FBSID_Pos           (0)                                               /*!< ELLSI_T::FBSID4: FBSID Position        */
#define ELLSI_FBSID4_FBSID_Msk           (0xfffffffful << ELLSI_FBSID4_FBSID_Pos)          /*!< ELLSI_T::FBSID4: FBSID Mask            */

#define ELLSI_FBPCNT5_FBPCNT_Pos         (0)                                               /*!< ELLSI_T::FBPCNT5: FBPCNT Position      */
#define ELLSI_FBPCNT5_FBPCNT_Msk         (0x3fful << ELLSI_FBPCNT5_FBPCNT_Pos)             /*!< ELLSI_T::FBPCNT5: FBPCNT Mask          */

#define ELLSI_FBPCNT5_FBPOV_Pos          (16)                                              /*!< ELLSI_T::FBPCNT5: FBPOV Position       */
#define ELLSI_FBPCNT5_FBPOV_Msk          (0x1ul << ELLSI_FBPCNT5_FBPOV_Pos)                /*!< ELLSI_T::FBPCNT5: FBPOV Mask           */

#define ELLSI_FBPCNT5_FBPCUR_Pos         (24)                                              /*!< ELLSI_T::FBPCNT5: FBPCUR Position      */
#define ELLSI_FBPCNT5_FBPCUR_Msk         (0x1ul << ELLSI_FBPCNT5_FBPCUR_Pos)               /*!< ELLSI_T::FBPCNT5: FBPCUR Mask          */

#define ELLSI_FBSID5_FBSID_Pos           (0)                                               /*!< ELLSI_T::FBSID5: FBSID Position        */
#define ELLSI_FBSID5_FBSID_Msk           (0xfffffffful << ELLSI_FBSID5_FBSID_Pos)          /*!< ELLSI_T::FBSID5: FBSID Mask            */

#define ELLSI_FBPCNT6_FBPCNT_Pos         (0)                                               /*!< ELLSI_T::FBPCNT6: FBPCNT Position      */
#define ELLSI_FBPCNT6_FBPCNT_Msk         (0x3fful << ELLSI_FBPCNT6_FBPCNT_Pos)             /*!< ELLSI_T::FBPCNT6: FBPCNT Mask          */

#define ELLSI_FBPCNT6_FBPOV_Pos          (16)                                              /*!< ELLSI_T::FBPCNT6: FBPOV Position       */
#define ELLSI_FBPCNT6_FBPOV_Msk          (0x1ul << ELLSI_FBPCNT6_FBPOV_Pos)                /*!< ELLSI_T::FBPCNT6: FBPOV Mask           */

#define ELLSI_FBPCNT6_FBPCUR_Pos         (24)                                              /*!< ELLSI_T::FBPCNT6: FBPCUR Position      */
#define ELLSI_FBPCNT6_FBPCUR_Msk         (0x1ul << ELLSI_FBPCNT6_FBPCUR_Pos)               /*!< ELLSI_T::FBPCNT6: FBPCUR Mask          */

#define ELLSI_FBSID6_FBSID_Pos           (0)                                               /*!< ELLSI_T::FBSID6: FBSID Position        */
#define ELLSI_FBSID6_FBSID_Msk           (0xfffffffful << ELLSI_FBSID6_FBSID_Pos)          /*!< ELLSI_T::FBSID6: FBSID Mask            */

#define ELLSI_FBPCNT7_FBPCNT_Pos         (0)                                               /*!< ELLSI_T::FBPCNT7: FBPCNT Position      */
#define ELLSI_FBPCNT7_FBPCNT_Msk         (0x3fful << ELLSI_FBPCNT7_FBPCNT_Pos)             /*!< ELLSI_T::FBPCNT7: FBPCNT Mask          */

#define ELLSI_FBPCNT7_FBPOV_Pos          (16)                                              /*!< ELLSI_T::FBPCNT7: FBPOV Position       */
#define ELLSI_FBPCNT7_FBPOV_Msk          (0x1ul << ELLSI_FBPCNT7_FBPOV_Pos)                /*!< ELLSI_T::FBPCNT7: FBPOV Mask           */

#define ELLSI_FBPCNT7_FBPCUR_Pos         (24)                                              /*!< ELLSI_T::FBPCNT7: FBPCUR Position      */
#define ELLSI_FBPCNT7_FBPCUR_Msk         (0x1ul << ELLSI_FBPCNT7_FBPCUR_Pos)               /*!< ELLSI_T::FBPCNT7: FBPCUR Mask          */

#define ELLSI_FBSID7_FBSID_Pos           (0)                                               /*!< ELLSI_T::FBSID7: FBSID Position        */
#define ELLSI_FBSID7_FBSID_Msk           (0xfffffffful << ELLSI_FBSID7_FBSID_Pos)          /*!< ELLSI_T::FBSID7: FBSID Mask            */

#define ELLSI_FBPCNT8_FBPCNT_Pos         (0)                                               /*!< ELLSI_T::FBPCNT8: FBPCNT Position      */
#define ELLSI_FBPCNT8_FBPCNT_Msk         (0x3fful << ELLSI_FBPCNT8_FBPCNT_Pos)             /*!< ELLSI_T::FBPCNT8: FBPCNT Mask          */

#define ELLSI_FBPCNT8_FBPOV_Pos          (16)                                              /*!< ELLSI_T::FBPCNT8: FBPOV Position       */
#define ELLSI_FBPCNT8_FBPOV_Msk          (0x1ul << ELLSI_FBPCNT8_FBPOV_Pos)                /*!< ELLSI_T::FBPCNT8: FBPOV Mask           */

#define ELLSI_FBPCNT8_FBPCUR_Pos         (24)                                              /*!< ELLSI_T::FBPCNT8: FBPCUR Position      */
#define ELLSI_FBPCNT8_FBPCUR_Msk         (0x1ul << ELLSI_FBPCNT8_FBPCUR_Pos)               /*!< ELLSI_T::FBPCNT8: FBPCUR Mask          */

#define ELLSI_FBSID8_FBSID_Pos           (0)                                               /*!< ELLSI_T::FBSID8: FBSID Position        */
#define ELLSI_FBSID8_FBSID_Msk           (0xfffffffful << ELLSI_FBSID8_FBSID_Pos)          /*!< ELLSI_T::FBSID8: FBSID Mask            */

#define ELLSI_FBPCNT9_FBPCNT_Pos         (0)                                               /*!< ELLSI_T::FBPCNT9: FBPCNT Position      */
#define ELLSI_FBPCNT9_FBPCNT_Msk         (0x3fful << ELLSI_FBPCNT9_FBPCNT_Pos)             /*!< ELLSI_T::FBPCNT9: FBPCNT Mask          */

#define ELLSI_FBPCNT9_FBPOV_Pos          (16)                                              /*!< ELLSI_T::FBPCNT9: FBPOV Position       */
#define ELLSI_FBPCNT9_FBPOV_Msk          (0x1ul << ELLSI_FBPCNT9_FBPOV_Pos)                /*!< ELLSI_T::FBPCNT9: FBPOV Mask           */

#define ELLSI_FBPCNT9_FBPCUR_Pos         (24)                                              /*!< ELLSI_T::FBPCNT9: FBPCUR Position      */
#define ELLSI_FBPCNT9_FBPCUR_Msk         (0x1ul << ELLSI_FBPCNT9_FBPCUR_Pos)               /*!< ELLSI_T::FBPCNT9: FBPCUR Mask          */

#define ELLSI_FBSID9_FBSID_Pos           (0)                                               /*!< ELLSI_T::FBSID9: FBSID Position        */
#define ELLSI_FBSID9_FBSID_Msk           (0xfffffffful << ELLSI_FBSID9_FBSID_Pos)          /*!< ELLSI_T::FBSID9: FBSID Mask            */

#define ELLSI_FBPCNT10_FBPCNT_Pos        (0)                                               /*!< ELLSI_T::FBPCNT10: FBPCNT Position     */
#define ELLSI_FBPCNT10_FBPCNT_Msk        (0x3fful << ELLSI_FBPCNT10_FBPCNT_Pos)            /*!< ELLSI_T::FBPCNT10: FBPCNT Mask         */

#define ELLSI_FBPCNT10_FBPOV_Pos         (16)                                              /*!< ELLSI_T::FBPCNT10: FBPOV Position      */
#define ELLSI_FBPCNT10_FBPOV_Msk         (0x1ul << ELLSI_FBPCNT10_FBPOV_Pos)               /*!< ELLSI_T::FBPCNT10: FBPOV Mask          */

#define ELLSI_FBPCNT10_FBPCUR_Pos        (24)                                              /*!< ELLSI_T::FBPCNT10: FBPCUR Position     */
#define ELLSI_FBPCNT10_FBPCUR_Msk        (0x1ul << ELLSI_FBPCNT10_FBPCUR_Pos)              /*!< ELLSI_T::FBPCNT10: FBPCUR Mask         */

#define ELLSI_FBSID10_FBSID_Pos          (0)                                               /*!< ELLSI_T::FBSID10: FBSID Position       */
#define ELLSI_FBSID10_FBSID_Msk          (0xfffffffful << ELLSI_FBSID10_FBSID_Pos)         /*!< ELLSI_T::FBSID10: FBSID Mask           */

#define ELLSI_FBPCNT11_FBPCNT_Pos        (0)                                               /*!< ELLSI_T::FBPCNT11: FBPCNT Position     */
#define ELLSI_FBPCNT11_FBPCNT_Msk        (0x3fful << ELLSI_FBPCNT11_FBPCNT_Pos)            /*!< ELLSI_T::FBPCNT11: FBPCNT Mask         */

#define ELLSI_FBPCNT11_FBPOV_Pos         (16)                                              /*!< ELLSI_T::FBPCNT11: FBPOV Position      */
#define ELLSI_FBPCNT11_FBPOV_Msk         (0x1ul << ELLSI_FBPCNT11_FBPOV_Pos)               /*!< ELLSI_T::FBPCNT11: FBPOV Mask          */

#define ELLSI_FBPCNT11_FBPCUR_Pos        (24)                                              /*!< ELLSI_T::FBPCNT11: FBPCUR Position     */
#define ELLSI_FBPCNT11_FBPCUR_Msk        (0x1ul << ELLSI_FBPCNT11_FBPCUR_Pos)              /*!< ELLSI_T::FBPCNT11: FBPCUR Mask         */

#define ELLSI_FBSID11_FBSID_Pos          (0)                                               /*!< ELLSI_T::FBSID11: FBSID Position       */
#define ELLSI_FBSID11_FBSID_Msk          (0xfffffffful << ELLSI_FBSID11_FBSID_Pos)         /*!< ELLSI_T::FBSID11: FBSID Mask           */

#define ELLSI_FBPCNT12_FBPCNT_Pos        (0)                                               /*!< ELLSI_T::FBPCNT12: FBPCNT Position     */
#define ELLSI_FBPCNT12_FBPCNT_Msk        (0x3fful << ELLSI_FBPCNT12_FBPCNT_Pos)            /*!< ELLSI_T::FBPCNT12: FBPCNT Mask         */

#define ELLSI_FBPCNT12_FBPOV_Pos         (16)                                              /*!< ELLSI_T::FBPCNT12: FBPOV Position      */
#define ELLSI_FBPCNT12_FBPOV_Msk         (0x1ul << ELLSI_FBPCNT12_FBPOV_Pos)               /*!< ELLSI_T::FBPCNT12: FBPOV Mask          */

#define ELLSI_FBPCNT12_FBPCUR_Pos        (24)                                              /*!< ELLSI_T::FBPCNT12: FBPCUR Position     */
#define ELLSI_FBPCNT12_FBPCUR_Msk        (0x1ul << ELLSI_FBPCNT12_FBPCUR_Pos)              /*!< ELLSI_T::FBPCNT12: FBPCUR Mask         */

#define ELLSI_FBSID12_FBSID_Pos          (0)                                               /*!< ELLSI_T::FBSID12: FBSID Position       */
#define ELLSI_FBSID12_FBSID_Msk          (0xfffffffful << ELLSI_FBSID12_FBSID_Pos)         /*!< ELLSI_T::FBSID12: FBSID Mask           */

#define ELLSI_FBPCNT13_FBPCNT_Pos        (0)                                               /*!< ELLSI_T::FBPCNT13: FBPCNT Position     */
#define ELLSI_FBPCNT13_FBPCNT_Msk        (0x3fful << ELLSI_FBPCNT13_FBPCNT_Pos)            /*!< ELLSI_T::FBPCNT13: FBPCNT Mask         */

#define ELLSI_FBPCNT13_FBPOV_Pos         (16)                                              /*!< ELLSI_T::FBPCNT13: FBPOV Position      */
#define ELLSI_FBPCNT13_FBPOV_Msk         (0x1ul << ELLSI_FBPCNT13_FBPOV_Pos)               /*!< ELLSI_T::FBPCNT13: FBPOV Mask          */

#define ELLSI_FBPCNT13_FBPCUR_Pos        (24)                                              /*!< ELLSI_T::FBPCNT13: FBPCUR Position     */
#define ELLSI_FBPCNT13_FBPCUR_Msk        (0x1ul << ELLSI_FBPCNT13_FBPCUR_Pos)              /*!< ELLSI_T::FBPCNT13: FBPCUR Mask         */

#define ELLSI_FBSID13_FBSID_Pos          (0)                                               /*!< ELLSI_T::FBSID13: FBSID Position       */
#define ELLSI_FBSID13_FBSID_Msk          (0xfffffffful << ELLSI_FBSID13_FBSID_Pos)         /*!< ELLSI_T::FBSID13: FBSID Mask           */

#define ELLSI_FBPCNT14_FBPCNT_Pos        (0)                                               /*!< ELLSI_T::FBPCNT14: FBPCNT Position     */
#define ELLSI_FBPCNT14_FBPCNT_Msk        (0x3fful << ELLSI_FBPCNT14_FBPCNT_Pos)            /*!< ELLSI_T::FBPCNT14: FBPCNT Mask         */

#define ELLSI_FBPCNT14_FBPOV_Pos         (16)                                              /*!< ELLSI_T::FBPCNT14: FBPOV Position      */
#define ELLSI_FBPCNT14_FBPOV_Msk         (0x1ul << ELLSI_FBPCNT14_FBPOV_Pos)               /*!< ELLSI_T::FBPCNT14: FBPOV Mask          */

#define ELLSI_FBPCNT14_FBPCUR_Pos        (24)                                              /*!< ELLSI_T::FBPCNT14: FBPCUR Position     */
#define ELLSI_FBPCNT14_FBPCUR_Msk        (0x1ul << ELLSI_FBPCNT14_FBPCUR_Pos)              /*!< ELLSI_T::FBPCNT14: FBPCUR Mask         */

#define ELLSI_FBSID14_FBSID_Pos          (0)                                               /*!< ELLSI_T::FBSID14: FBSID Position       */
#define ELLSI_FBSID14_FBSID_Msk          (0xfffffffful << ELLSI_FBSID14_FBSID_Pos)         /*!< ELLSI_T::FBSID14: FBSID Mask           */

#define ELLSI_FBPCNT15_FBPCNT_Pos        (0)                                               /*!< ELLSI_T::FBPCNT15: FBPCNT Position     */
#define ELLSI_FBPCNT15_FBPCNT_Msk        (0x3fful << ELLSI_FBPCNT15_FBPCNT_Pos)            /*!< ELLSI_T::FBPCNT15: FBPCNT Mask         */

#define ELLSI_FBPCNT15_FBPOV_Pos         (16)                                              /*!< ELLSI_T::FBPCNT15: FBPOV Position      */
#define ELLSI_FBPCNT15_FBPOV_Msk         (0x1ul << ELLSI_FBPCNT15_FBPOV_Pos)               /*!< ELLSI_T::FBPCNT15: FBPOV Mask          */

#define ELLSI_FBPCNT15_FBPCUR_Pos        (24)                                              /*!< ELLSI_T::FBPCNT15: FBPCUR Position     */
#define ELLSI_FBPCNT15_FBPCUR_Msk        (0x1ul << ELLSI_FBPCNT15_FBPCUR_Pos)              /*!< ELLSI_T::FBPCNT15: FBPCUR Mask         */

#define ELLSI_FBSID15_FBSID_Pos          (0)                                               /*!< ELLSI_T::FBSID15: FBSID Position       */
#define ELLSI_FBSID15_FBSID_Msk          (0xfffffffful << ELLSI_FBSID15_FBSID_Pos)         /*!< ELLSI_T::FBSID15: FBSID Mask           */
