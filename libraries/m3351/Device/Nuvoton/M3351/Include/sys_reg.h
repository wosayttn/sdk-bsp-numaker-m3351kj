...
typedef struct
{
     ...
     * |        |          |The MCU reset flag is set by the u201CReset Signalu201D from the Cortex-M33 Core to indicate the previous reset source.
     ...
     * |        |          |The HRESET reset flag is set by the u201CReset Signalu201D from the HRESET.
