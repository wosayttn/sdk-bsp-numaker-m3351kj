...
#if __has_include("nu_partition_M3351.h")
    #include "nu_partition_M3351.h"                  /* User defined setup for Secure/Non-Secure Zones */
#else
    #include "nu_partition_M3351_template.h"         /* Default setup for Secure/Non-Secure Zones */
#endif

#if __has_include("nu_mpu_config_M3351.h")
    #include "nu_mpu_config_M3351.h"                  /* User defined setup for MPU regions */
#else
    #include "nu_mpu_config_M3351_template.h"         /* Default setup for MPU regions */
#endif
